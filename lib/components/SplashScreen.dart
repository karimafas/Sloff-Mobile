...
import 'package:sloff/pages/onboarding/RegularSurvey.dart';
import 'package:sloff/pages/onboarding/SloffTeamSurvey.dart';
            ...
            widget.uuid == null
                ...
                : FutureBuilder(
                    ...
                    builder: (context, snapshot) {
                      if (!snapshot.hasData) {
                        return HomeInitialPage(analytics: widget.analytics);
                      }
