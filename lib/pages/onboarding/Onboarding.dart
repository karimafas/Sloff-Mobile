...
class _OnboardingState extends State<Onboarding> {
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        AnimatedContainer(
            color: _currentIndex >= 2 ? new Color(0xFFFFF8ED) : new Color(0xFF190E3B),
      ...
      body: Stack(
        ...
        children: [
          ...
          BackdropFilter(
            ...
            child: Stack(
              children: [
                _riveArtboard == null ? Container() : SlideYFadeInBottom(2, Transform.scale(child: Rive(artboard: _riveArtboard), scale: MediaQuery.of(context).size.width * 0.004)),
                Column(
                          ...
                          children: [
                            ...
                            Text("ready-text".tr(),
                                style: TextStyle(
                                    ...
                                    fontSize: 12,
                                    color: new Color(0xFF190E3B)), textAlign: TextAlign.center),
                          ],
                        ),
                      ),
                    ),
                          ...
                          RectangleButton(
                            onTap: () {
                              Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => HomeInitialPage()));
                            },
