...
class CouponConfirm extends StatefulWidget {
  ...
  const CouponConfirm({Key key, this.id, this.focushour, this.couponid})
      : super(key: key);
...
class _CouponConfirm extends State<CouponConfirm> {
                    ...
                    if (!snapshot.hasData) {
                      ...
                      return new RichText(
                        ...
                        text: new TextSpan(
                          ...
                          children: <TextSpan>[
                            new TextSpan(
                                text: 'CouponCosto1'.tr(namedArgs: {
                                  'ore': snapshot.data['total_focus'].toString()
                                }),
                                style: new TextStyle(
                                    fontSize: 18.0,
                                    letterSpacing: -0.8,
                  ...
                  if (!snapshot.hasData) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          buildItem(context, snapshot.data, widget.focushour),
                      itemCount: 1,
                    );
                  }
                }),
                    ...
                    onTap: () async {
                      ...
                      if (coupon.exists) {
                        ...
                        FirebaseFirestore.instance
                          ...
                          "completed":
                              providerId['total_coupon'] - 1 > 0 ? false : true,
                          "visible":
                              providerId['total_coupon'] - 1 > 0 ? true : false,
                          "code": codes,
                        }).then((value) async {
  ...
  Widget buildItem(
      BuildContext context, DocumentSnapshot document, int focushour) {
    if (document['visible']) {
