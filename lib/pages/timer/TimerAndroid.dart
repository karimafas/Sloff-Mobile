...
class TimerAndroid extends StatefulWidget {
  const TimerAndroid({Key key, this.callback}) : super(key: key);
...
class _Timer extends State<TimerAndroid>
        ...
        BackdropFilter(
          ...
          child: StreamBuilder(
              ...
              builder: (context, snapshot) {
                ...
                //print(snapshot.data.docs[0]['start_time']);
