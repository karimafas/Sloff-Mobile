...
class Welcome extends StatefulWidget {
  ...
  const Welcome({Key key, this.email, this.name}) : super(key: key);
                      ...
                      RectangleButton(
                        ...
                        onTap: () {
                          ...
                          pushReplacementWithFade(
                              context,
                              SignUp2(email: widget.email, name: widget.name),
                              600);
                        },
                      ),
                    )
...
class SignUp2 extends StatefulWidget {
  ...
  const SignUp2({Key key, this.email, this.name}) : super(key: key);
        ...
        Row(
          ...
          children: [
            Container(
                ...
                width: 180,
                color: new Color(0xFF694EFF).withOpacity(.4)),
            Container(height: 4, width: 180, color: new Color(0xFF694EFF))
          ],
        ),
        SizedBox(height: 30),
